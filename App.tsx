...
const App = () => {
    ...
    const SettingsMenuContent = () => (
        <>
            ...
            <button onClick={handleChangePassword} className="w-full text-left px-5 py-4 text-xs font-bold text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-800 border-b border-slate-100 dark:border-slate-800 flex items-center gap-3">
